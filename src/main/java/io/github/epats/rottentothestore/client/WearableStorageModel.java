...
public class WearableStorageModel<EntityT extends LivingEntity> extends HumanoidModel<EntityT> {
    ...
    public Map<BackpackParts, ModelPart> setModelParts(ModelPart part) {
        ...
        builder.put(BackpackParts.BUNDLE_SIDE_STRAP, part.getChild("body").getChild(BUNDLE_SIDE_STRAP));
    ...
    public static LayerDefinition createBodyLayer(boolean isWorn) {
        ...
        leftLeg.addOrReplaceChild(BUNDLE_SIDE, CubeListBuilder.create()
                        .texOffs(0, 0)
                        .addBox(1.5F, -3F, -4F, 4F, 4F, 4F, CubeDeformation.NONE)
                        .texOffs(16, 4)
                        .addBox(1.5F, -4F, -3F, 2F, 2F, 2F, CubeDeformation.NONE),
                        PartPose.offset(1.5F, 64.0F, 0.0F));
        ...
        body.addOrReplaceChild(BUNDLE_SIDE_STRAP, CubeListBuilder.create()
                .texOffs(0, 8)
                .addBox(-4.2F, 2F, -5F, 8.4F, 2F, 4.5F, new CubeDeformation(0.0F)),
    ...
    public void copyPropertiesThrough() {
        ...
        this.leftLeg.getChild(BUNDLE_SIDE).xRot *= 1F;
    }
}
